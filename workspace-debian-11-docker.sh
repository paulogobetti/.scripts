#!/usr/bin/env bash
#
# wget https://raw.githubusercontent.com/paulogobetti/scripts/main/workspace-debian-11-docker.sh -O /home/$USER/install.sh && chmod +x install.sh && ./install.sh
#
# curl -s "https://laravel.build/appname?with=mysql,redis" | bash
#
# # # #
